...
//         <a href="./movieDetails.html?id=${results[index].id}"
...
//               }"
//               alt="movie"
//               title="${results[index].original_title}"/></div>
...
//     `https://api.themoviedb.org/3/movie/popular?language=en-US&page=${pageCount}`,
//     getPopular
//   );
...
//           results[index].id
//         }">${results[index].original_title}</a>
//         <p>${new Date(results[index].release_date).toLocaleDateString("en-us", {
//           year: "numeric",
//           month: "short",
//           day: "numeric",
//         })}</p>
